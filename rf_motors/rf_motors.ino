...
void loop() {
  ...
  if (radio.available()) {   // If the NRF240L01 module received data
    radio.read(&recievedData, sizeof(recievedData)); // Read the data and put it into character array
    xAxis = atoi(&recievedData[0]); // Convert the data from the character array (received X value) into integer
    delay(10);
